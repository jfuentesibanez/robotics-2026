...
img/                   the 19 animated illustrations — keep this folder next to the HTML
...
`01-asimov-1967` · `03-figure-helix` · `04-unitree-h2` ·
...
**Illustrations — how the animation is handled.** The 19 pieces are six-second loops, 38 MB in
